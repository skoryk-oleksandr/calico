...
// VerifyAndSwapOwnerAttribute atomically verifies the target pod is in AlternateOwnerAttrs
...
// target node.
func VerifyAndSwapOwnerAttribute(
	ctx context.Context,
...
func verifyAndSwapSingleIP(
	...
	updates := &OwnerAttributeUpdates{
		...
		AlternateOwnerAttrs: allocAttr.ActiveOwnerAttrs,    // Source (or empty) becomes alternate
	}
